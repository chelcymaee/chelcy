...
const styles = StyleSheet.create({
  ...
  trustNote: { flexDirection: 'row', gap: 10, backgroundColor: '#F0F9FF', borderRadius: 12, padding: 14 },
  ...
  btnSecondary: { borderRadius: 16, paddingVertical: 14, alignItems: 'center', borderWidth: 1, borderColor: Colors.border },
